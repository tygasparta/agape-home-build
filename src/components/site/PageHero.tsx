    ...
    <section className="border-b border-border bg-mist/60">
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 py-16 sm:px-8 sm:py-20 lg:grid-cols-2 lg:gap-16 lg:py-24">
        <Reveal>
          ...
          <h1 className="mt-5 text-balance text-4xl leading-[1.1] sm:text-5xl lg:text-[3.25rem]">{title}</h1>
          <div className="mt-6 max-w-xl space-y-4 text-[1.0625rem] leading-relaxed text-muted-foreground">
